    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'image',
                    models.ImageField(
                        upload_to='', verbose_name='Фотография продукта'
                    ),
                ),
                (
                    'country',
                    models.CharField(
                        max_length=40, verbose_name='Страна-производитель'
                    ),
                ),
                (
                    'brand',
                    models.CharField(
                        max_length=100, null=True, verbose_name='Бренд'
                    ),
                ),
                (
                    'warranty',
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name='materials', to='product.material'
                    ),
                ),
            ],
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=('product', 'user'), name='product_user_unique'
            ),
        ),
    ]
